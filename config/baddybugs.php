...
return [
    ...
    */
    "endpoint" => env(
        "BADDYBUGS_ENDPOINT",
        "https://api.baddybugs.com/v1/ingest",
    ),
    ...
    */
    "collectors" => [
        ...
        "http_client" => true,
        "models" => true,
        "models_detailed" => true, // Full model event logging (high volume)
        "profiling" => true,
        "gate" => true,
        "redis" => true,
        ...
        "translations" => [
            "enabled" => env(
                "BADDYBUGS_COLLECTORS_TRANSLATIONS_ENABLED",
                false,
            ),
            "options" => [
                "track_missing" => true,
        ...
        "handled_exceptions" => [
            "enabled" => env(
                "BADDYBUGS_COLLECTORS_HANDLED_EXCEPTIONS_ENABLED",
                true,
            ),
        ],
        ...
        // Advanced Query Builder analytics
        "query_builder" => [
            "enabled" => env(
                "BADDYBUGS_COLLECTORS_QUERY_BUILDER_ENABLED",
                true,
            ),
        ],

        // Eloquent Observer tracking
        "observers" => [
            "enabled" => env("BADDYBUGS_COLLECTORS_OBSERVERS_ENABLED", false),
        ],

        // Advanced Eloquent tracking (scopes, casts, accessors)
        "advanced_eloquent" => [
            "enabled" => env(
                "BADDYBUGS_COLLECTORS_ADVANCED_ELOQUENT_ENABLED",
                false,
            ),
        ],

        // Password hashing tracking
        "hashing" => [
    ...
    */
    ...
    "ignore_domains" => [
        parse_url(
            env("BADDYBUGS_ENDPOINT", "https://api.baddybugs.test"),
            PHP_URL_HOST,
        ),
    ],

    "http_client_slow_threshold_ms" => env(
        "BADDYBUGS_HTTP_CLIENT_SLOW_MS",
        500,
    ),
    "http_client_error_force_sample" => env(
        "BADDYBUGS_HTTP_CLIENT_ERROR_FORCE",
        true,
    ),
    ...
    */
    ...
    "frontend_web_vitals_sampling_rate" => env(
        "BADDYBUGS_FRONTEND_WEB_VITALS_SAMPLING_RATE",
        1.0,
    ),
     ...
     */
    "livewire_track_initialization" => env(
        "BADDYBUGS_LIVEWIRE_TRACK_INIT",
        false,
    ),
    ...
    */
     ...
     */
    "session_replay_sampling_rate" => env(
        "BADDYBUGS_SESSION_REPLAY_SAMPLING_RATE",
        0.01,
    ),
     ...
     */
    "session_replay_privacy_mode" => env(
        "BADDYBUGS_SESSION_REPLAY_PRIVACY",
        "strict",
    ),
     ...
     */
    "session_replay_record_canvas" => env(
        "BADDYBUGS_SESSION_REPLAY_RECORD_CANVAS",
        false,
    ), // Record canvas elements (charts, etc.)
    "session_replay_record_network" => env(
        "BADDYBUGS_SESSION_REPLAY_RECORD_NETWORK",
        true,
    ), // Record network requests
    "session_replay_record_console" => env(
        "BADDYBUGS_SESSION_REPLAY_RECORD_CONSOLE",
        true,
    ), // Record console logs
    "session_replay_record_performance" => env(
        "BADDYBUGS_SESSION_REPLAY_RECORD_PERFORMANCE",
        true,
     ...
     */
    "session_replay_sampling_strategy" => env(
        "BADDYBUGS_SESSION_REPLAY_SAMPLING_STRATEGY",
        "deterministic",
    ),
    ...
    */
     ...
     */
    "profiling_memory_threshold" => env(
        "BADDYBUGS_PROFILING_MEMORY_THRESHOLD",
        50 * 1024 * 1024,
    ), // 50 MB
     ...
     */
    "profiling_phase_breakdown" => env(
        "BADDYBUGS_PROFILING_PHASE_BREAKDOWN",
        true,
    ),
     ...
     */
    "profiling_flamegraph_data" => env(
        "BADDYBUGS_PROFILING_FLAMEGRAPH_DATA",
        true,
    ),
    ...
    */
     ...
     */
    "security_scan_sensitive_data" => env(
        "BADDYBUGS_SECURITY_SCAN_SENSITIVE_DATA",
        true,
    ),
     ...
     */
    "security_scan_sql_injection" => env(
        "BADDYBUGS_SECURITY_SCAN_SQL_INJECTION",
        true,
    ),
     ...
     */
    "security_detect_dangerous_usage" => env(
        "BADDYBUGS_SECURITY_DETECT_DANGEROUS_USAGE",
        true,
    ),
    ...
    */
     ...
     */
    "feature_tracking_enabled" => env(
        "BADDYBUGS_FEATURE_TRACKING_ENABLED",
        true,
    ),
     ...
     */
    "feature_track_custom_events" => env(
        "BADDYBUGS_FEATURE_TRACK_CUSTOM_EVENTS",
        false,
    ),
    ...
    */
     ...
     */
    "timeline_detail_level" => env(
        "BADDYBUGS_TIMELINE_DETAIL_LEVEL",
        "detailed",
    ),
     ...
     */
    "lifecycle_tracking_enabled" => env(
        "BADDYBUGS_LIFECYCLE_TRACKING_ENABLED",
        true,
    ),
    ...
    */
     ...
     */
    "database_explain_queries" => env(
        "BADDYBUGS_DATABASE_EXPLAIN_QUERIES",
        false,
    ),
     ...
     */
    "database_explain_threshold" => env(
        "BADDYBUGS_DATABASE_EXPLAIN_THRESHOLD",
        1000,
    ), // 1 second
     ...
     */
    "cache_detect_thundering_herd" => env(
        "BADDYBUGS_CACHE_DETECT_THUNDERING_HERD",
        true,
    ),
    ...
    */
     ...
     */
    "health_monitoring_enabled" => env(
        "BADDYBUGS_HEALTH_MONITORING_ENABLED",
        true,
    ),
     ...
     */
    "health_detect_stuck_jobs" => env(
        "BADDYBUGS_HEALTH_DETECT_STUCK_JOBS",
        true,
    ),
     ...
     */
    "health_stuck_job_threshold" => env(
        "BADDYBUGS_HEALTH_STUCK_JOB_THRESHOLD",
        3600,
    ), // 1 hour
     ...
     */
    "health_heartbeat_interval" => env(
        "BADDYBUGS_HEALTH_HEARTBEAT_INTERVAL",
        60,
    ),
    ...
    */
     ...
     */
    "git_deployment_tag" => env(
        "DEPLOYMENT_TAG",
        env("BADDYBUGS_DEPLOYMENT_TAG"),
    ),
    ...
    */
     ...
     */
    "regression_capture_baselines" => env(
        "BADDYBUGS_REGRESSION_CAPTURE_BASELINES",
        true,
    ),
     ...
     */
    "regression_baseline_snapshot_interval" => env(
        "BADDYBUGS_REGRESSION_BASELINE_INTERVAL",
        100,
    ),
     ...
     */
    "deployment_header_name" => env(
        "BADDYBUGS_DEPLOYMENT_HEADER",
        "X-Deployment-ID",
    ),
    ...
    "llm_rates" => [
        "openai" => [
            ...
            "gpt-4o-mini" => ["in" => 0.0003 / 1000, "out" => 0.001 / 1000],
            "gpt-4.1-mini" => ["in" => 0.0005 / 1000, "out" => 0.002 / 1000],
        ...
        "google" => [
            ...
            "gemini-3-flash" => ["in" => 0.0005 / 1000, "out" => 0.003 / 1000],
